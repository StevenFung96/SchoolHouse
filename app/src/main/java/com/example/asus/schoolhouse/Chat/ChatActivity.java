            ...
            public void onChildAdded(DataSnapshot dataSnapshot, String s) {
                ...
                /*mMessagesList.addOnScrollListener(new RecyclerView.OnScrollListener() {
                    ...
                    public void onScrolled(RecyclerView recyclerView, int dx, int dy) {
                        ...
                        visibleItemCount = mMessagesList.getChildCount();
                        totalItemCount = mLinearLayout.getItemCount();
                        firstVisibleItem = mLinearLayout.findFirstVisibleItemPosition();
